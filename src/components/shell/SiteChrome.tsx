      ...
      <footer className="premium-footer">
        <div className="premium-footer-grid">
          ...
          <section className="premium-footer-links">
            ...
            <div><strong>Legal</strong><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link><Link href="/cookies">Cookies</Link><Link href="/dpa">DPA</Link><Link href="/subprocessors">Subprocessors</Link><Link href="/accessibility">Accessibility</Link></div>
