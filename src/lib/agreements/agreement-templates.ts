...
export const AGREEMENT_TEMPLATE_REGISTRY: AgreementTemplate[] = [
  ...
  },
  {
    ...
    kind: 'scope_addendum',
    description: 'Delta scope annexure and commercial expansion attached to an active agreement.',
    requiredApprovals: 1,
    signingMode: 'email',
  ...
  },
  {
    ...
    description: 'Commercial annexure used alongside invoices, payment requests, and governed execution records.',
    requiredApprovals: 1,
    signingMode: 'manual',
