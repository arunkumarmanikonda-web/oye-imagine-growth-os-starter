...
export function getOperatorDashboardExperience() {
  return {
    ...
    subtitle: 'Governed admin command center for content, config, support, and runtime controls.',
    cards: [
      {
      ...
      },
      {
        ...
        href: '/admin/support',
        description: 'Triaged support inbox for commercial, client-success, and marketplace events.'
      },
      {
        title: 'Runtime enforcement',
        href: '/admin/runtime',
        description: 'Track shell separation, route-guard posture, and runtime access governance.'
      }
    ]
  }
}
