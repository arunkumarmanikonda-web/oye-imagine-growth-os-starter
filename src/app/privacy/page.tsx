...
export const metadata: Metadata = {
  title: 'Privacy Notice | Oye !magine',
  description: 'Review how Oye Imagine Private Limited collects, uses, shares, secures, retains and handles personal data across oyeimagine.com and the AI Growth OS.',
}
    ...
    <PolicyPage
      ...
      sections={[
        ...
        },
        {
          ...
          body: 'We may receive data directly from you, from authorised users in your organisation, from connected providers you deliberately authorise, from website and product interactions, from commercial or support communications, and from service providers acting on our behalf.'
        },
        {
        ...
        },
        {
          ...
          body: 'Configured AI features may process customer-provided or workspace-authorised content to generate, classify, retrieve, summarise or assist with operational work. High-impact actions should remain subject to the applicable permissions, approvals and provider controls. We do not treat every AI-generated output as authoritative and customers should review outputs before material business use.'
        },
        {
          title: '7. Connected providers and subprocessors',
          body: 'We may use infrastructure, communications, AI and other service providers to deliver the platform. Customers may also connect their own advertising, analytics, commerce, messaging, payment, eSign or other providers. Our public Subprocessors page describes the principal provider categories, while tenant-specific provider use depends on actual configuration and scope.'
        },
        {
        ...
        },
        {
          ...
          body: 'Technology providers may process data in more than one country. Where cross-border transfer restrictions apply, we intend to use the contractual, technical or organisational safeguards required by the applicable legal framework and customer agreement.'
        },
        {
          title: '10. Data retention',
          body: 'We retain information only for as long as reasonably necessary for service delivery, support, security, contractual, financial, tax, audit, legal or dispute requirements. Retention periods vary by record type. Customer-specific deletion, return or export requirements may be defined in an order form, enterprise agreement or DPA.'
        },
        {
          title: '11. Security',
        ...
        },
        {
          ...
          body: 'Depending on the law that applies to you, you may have rights to request access, correction, deletion, portability, restriction, objection, withdrawal of consent or information about processing. Requests involving customer-controlled data may need to be routed through the relevant customer organisation so that identity and authority can be verified.'
        },
        {
          title: '13. India and DPDP Act context',
          body: 'For processing governed by India’s Digital Personal Data Protection framework, Oye !magine intends to support lawful notice, consent where required, reasonable security safeguards, grievance handling and rights-response processes appropriate to its role in the relevant processing relationship.'
        },
        {
          title: '14. Children',
          body: 'The Oye !magine business service is not directed to children. Users must not deliberately submit children’s personal data unless the customer has a lawful, documented basis and the service scope expressly supports that processing.'
        },
        {
          title: '15. Cookies and similar technologies',
          body: 'The Cookie Policy explains how essential and optional browser technologies may be used. Where optional analytics or marketing consent is legally required, those technologies should not be activated before the relevant consent or preference choice is obtained.'
        },
        {
          title: '16. Contact and grievances',
          body: 'Privacy questions, rights requests or grievances may be submitted through the Contact page or by email to hello@oyeimagine.com. We may request information needed to verify identity, authority and the relevant tenant or commercial context before acting on a request.'
        },
        {
          title: '17. Changes to this notice',
          body: 'We may update this Privacy Notice to reflect product, legal or operational changes. Material updates should be reflected by changing the date above and, where required, communicating the change to affected users or customers.'
        }
      ]}
    />
  )
