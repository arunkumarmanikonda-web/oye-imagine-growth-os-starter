...
export const metadata = buildMetadata(
  '/terms',
  'Terms of Service | Oye !magine',
  'Review the baseline terms governing access to and use of the Oye !magine AI Growth OS and related services.'
)
...
export default function TermsPage() {
  return (
    <PolicyPage
      ...
      sections={[
        { title: '1. Agreement and eligibility', body: 'By creating an account, accepting an order form, using the service or otherwise agreeing to these Terms, you confirm that you are authorised to bind yourself or the organisation you represent and that your use is lawful in the jurisdictions that apply to you.' },
        ...
        { title: '3. Accounts and access', bullets: [
        ...
        { title: '14. Liability', body: 'Any limitations, exclusions, caps, indemnities or special remedies are governed by the applicable signed commercial agreement. Where no separate agreement applies, liability is limited to the maximum extent permitted by applicable law and these Terms should not be read to exclude liability that cannot legally be excluded.' },
        { title: '15. Suspension and termination', body: 'Access may be suspended or terminated for material breach, security risk, unlawful use, non-payment, provider restrictions or other grounds stated in the applicable agreement. On termination, data export, retention and deletion follow the governing agreement, Privacy Notice and DPA where applicable.' },
        { title: '16. Governing law and notices', body: 'Unless a signed agreement states otherwise, the relationship is intended to be governed by the laws of India, with disputes subject to the forum specified in the applicable commercial agreement. Formal notices should use the legal or commercial contact identified in the relevant agreement; general product questions may be sent through the Contact page.' },
        { title: '17. Changes and order of precedence', body: 'We may update these public Terms prospectively. If there is a conflict, a signed enterprise agreement, order form, DPA or statement of work takes precedence for the subject it specifically governs.' }
      ]}
    />
  )
}
