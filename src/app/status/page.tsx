...
export const metadata: Metadata = {
  title: 'Service Status | Oye !magine',
  description: 'Service-status and incident communication information for Oye !magine public and authenticated product surfaces.',
}
      ...
      <section className="mx-auto max-w-5xl px-6 py-14 sm:px-8 lg:px-10">
        ...
        <div className="mt-8 rounded-3xl border border-slate-200 bg-slate-50 p-7">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-700">
            Material customer-impacting incidents should be communicated to affected customers through the applicable support and account channels. Security-sensitive matters may follow a restricted disclosure path while investigation is active.
          </p>
          <div className="mt-5 flex flex-wrap gap-3">
            <Link href="/trust" className="rounded-full border border-slate-300 px-4 py-2 text-sm font-medium">Trust Center</Link>
            <Link href="/contact" className="rounded-full bg-slate-950 px-4 py-2 text-sm font-medium text-white">Report an issue</Link>
          </div>
        </div>
      </section>
    </div>
