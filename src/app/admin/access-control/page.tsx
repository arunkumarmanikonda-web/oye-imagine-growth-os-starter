  ...
  return (
    <PremiumWorkspaceShell identity={identity}>
      <section className="rounded-[2.5rem] bg-[#111] p-6 text-white shadow-2xl md:p-9">
        ...
        <p className="mt-5 max-w-3xl text-base leading-8 text-white/60">Create identities, assign default role groups, suspend access, issue temporary credentials and override individual permissions at platform or workspace scope. All changes are auditable.</p>
        <div className="mt-9"><AccessControlConsole /></div>
      </section>
