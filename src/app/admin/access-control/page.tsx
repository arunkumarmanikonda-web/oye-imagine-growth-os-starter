...
import { DemoRoleBootstrapConsole } from '@/components/admin/DemoRoleBootstrapConsole'
  ...
  return (
    <PremiumWorkspaceShell identity={identity}>
      <section className="rounded-[2.5rem] bg-[#111] p-6 text-white shadow-2xl md:p-9">
        ...
        <div className="mt-9 space-y-7"><DemoRoleBootstrapConsole /><AccessControlConsole /><CustomRoleConsole /></div>
      </section>
