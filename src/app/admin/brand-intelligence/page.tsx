...
import { saveBrandIntelligenceFormAction } from "./actions";
    ...
    <main className="oi-stage-shell oi-editor-shell">
      ...
      <section className="oi-editor-grid">
        ...
        <article className="oi-editor-panel">
          ...
          <form action={saveBrandIntelligenceFormAction} className="oi-editor-form">
            ...
            <div className="oi-editor-actions">
              <AdminSaveButton idleLabel="Save brand profile" pendingLabel="Saving profile..." />
            </div>
          </form>
        </article>
      </section>
