...
const errorCopy: Record<string, string> = {
  invalid_signup: 'Complete every required field, use a strong password, choose a valid plan and accept the current Terms and Privacy Notice.',
  ...
  return (
    <main className="signup-premium-page">
      <section className="signup-story">
        ...
        <h1>Tell Oye the business story. We begin learning before commercial activation.</h1>
        <p>Your secure tenant, brand workspace and private operating context are created first. Provider-dependent, paid and high-impact capabilities remain governed by the applicable plan, commercial activation requirements, approvals and verified external connections.</p>
        <div className="signup-steps">
          {[
            ...
            ['03','Complete commercial activation','Complete the commercial, identity and payment steps required for your edition'],
            ['04','Activate governed operations','Enable approved modules, roles, providers, execution and reporting'],
      ...
      <section className="signup-form-wrap">
        <div className="signup-card">
          ...
          <div className="auth-form-heading"><p>Create customer account</p><h2>Open your growth workspace</h2><span>You become the first customer administrator for the workspace created for your organisation.</span></div>
          ...
          <form action="/api/auth/signup" method="post" className="signup-form">
            ...
            <input type="hidden" name="termsVersion" value={PUBLIC_TERMS_VERSION} />
            <input type="hidden" name="privacyVersion" value={PUBLIC_PRIVACY_VERSION} />
            ...
            <label className="auth-checkbox signup-terms"><input type="checkbox" name="terms" required /> <span>I agree to the <Link href="/terms" className="font-black underline" target="_blank">Terms</Link> and acknowledge the <Link href="/privacy" className="font-black underline" target="_blank">Privacy Notice</Link>. Commercial and provider-dependent capabilities remain subject to the applicable activation, payment, approval and connection requirements.</span></label>
