...
Invoke-LocalVitest @(
  'run'
  'tests/lib/foundation-recovery-company-profile.test.ts'
  'tests/lib/foundation-recovery-content-controller.test.ts'
  'tests/lib/foundation-recovery-provider-config-and-neejee.test.ts'
)
