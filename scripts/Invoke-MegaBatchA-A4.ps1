...
Invoke-LocalVitest @(
  ...
  "tests/lib/foundation-cms-control-plane.test.ts",
  "tests/lib/foundation-cms-ai-assist.test.ts",
  "tests/lib/foundation-resend-runtime.test.ts",
  "tests/lib/foundation-support-mail-log.test.ts",
  "tests/lib/foundation-support-operations.test.ts"
)

if ($LASTEXITCODE -ne 0) {
  throw "Focused Mega Batch A / A4 tests failed."
}
