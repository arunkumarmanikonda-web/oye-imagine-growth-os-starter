...
Invoke-LocalVitest @(
  'run',
  'tests/lib/foundation-commercial-agreement-execution-package.test.ts',
  'tests/lib/foundation-commercial-approval-execution.test.ts',
  'tests/lib/foundation-commercial-signature-prep.test.ts'
)
