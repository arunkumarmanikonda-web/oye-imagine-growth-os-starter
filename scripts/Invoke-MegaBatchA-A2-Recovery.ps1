...
Invoke-LocalVitest @(
  'run'
  'tests/lib/foundation-recovery-auth-session.test.ts'
  'tests/lib/foundation-recovery-route-guards.test.ts'
  'tests/lib/foundation-recovery-workspace-context.test.ts'
)
