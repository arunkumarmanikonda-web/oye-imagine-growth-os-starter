...
Invoke-LocalVitest @(
  'run',
  'tests/lib/foundation-recovery-surface-composer-public.test.ts',
  'tests/lib/foundation-recovery-surface-composer-commercial.test.ts',
  'tests/lib/foundation-recovery-surface-composer-operator.test.ts'
)
