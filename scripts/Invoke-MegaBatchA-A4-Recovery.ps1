...
Invoke-LocalVitest @(
  'run',
  'tests/lib/foundation-recovery-content-governance.test.ts',
  'tests/lib/foundation-recovery-content-ai-actions.test.ts',
  'tests/lib/foundation-recovery-content-publish-workflow.test.ts'
)
