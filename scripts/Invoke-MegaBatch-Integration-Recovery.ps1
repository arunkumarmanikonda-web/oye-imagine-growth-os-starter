...
Invoke-LocalVitest @(
  'run',
  'tests/lib/foundation-recovery-integration-manifest.test.ts',
  'tests/lib/foundation-recovery-integration-routes.test.ts',
  'tests/lib/foundation-recovery-integration-commercial-concierge.test.ts'
)
