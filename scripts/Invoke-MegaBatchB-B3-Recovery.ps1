...
Invoke-LocalVitest @(
  'run',
  'tests/lib/foundation-commercial-invoicing-types.test.ts',
  'tests/lib/foundation-commercial-invoice-generation.test.ts',
  'tests/lib/foundation-commercial-invoice-delivery-ledger.test.ts'
)
